 ...
 *  @author	Wes Garland
 *  @date	Dec 2007
 *  @version	$Id: query_object.c,v 1.2 2009/03/31 15:12:14 wes Exp $
 */

static const char __attribute__((unused)) rcsid[]="$Id: query_object.c,v 1.2 2009/03/31 15:12:14 wes Exp $";
