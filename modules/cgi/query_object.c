 ...
 *  @author	Wes Garland
 *  @date	Dec 2007
 *  @version	$Id: query_object.c,v 1.6 2010/12/02 21:59:42 wes Exp $
 */

static const char __attribute__((unused)) rcsid[]="$Id: query_object.c,v 1.6 2010/12/02 21:59:42 wes Exp $";
