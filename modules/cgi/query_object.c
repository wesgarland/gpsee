 ...
 *  @author	Wes Garland
 *  @date	Dec 2007
 *  @version	$Id: query_object.c,v 1.1 2009/03/30 23:55:44 wes Exp $
 */

static const char __attribute__((unused)) rcsid[]="$Id: query_object.c,v 1.1 2009/03/30 23:55:44 wes Exp $";
