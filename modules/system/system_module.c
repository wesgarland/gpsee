 ...
 *  @author     Wes Garland
 *  @date       Oct 2007
 *  @version    $Id: system_module.c,v 1.1 2009/03/30 23:55:45 wes Exp $
 */
 
static __attribute__((unused)) const char rcsid[]="$Id: system_module.c,v 1.1 2009/03/30 23:55:45 wes Exp $";
