 ...
 *		wes@page.ca
 *  @date	Jan 2008
 *  @version	$Id: ByteString.c,v 1.9 2010/09/01 18:12:35 wes Exp $
 *
...
static const char __attribute__((unused)) rcsid[]="$Id: ByteString.c,v 1.9 2010/09/01 18:12:35 wes Exp $";
#include "gpsee.h"
#include "binary.h"
