 ...
 *		wes@page.ca
 *  @date	Jan 2008
 *  @version	$Id: ByteString.c,v 1.10 2010/12/02 21:59:42 wes Exp $
 *
...
static const char __attribute__((unused)) rcsid[]="$Id: ByteString.c,v 1.10 2010/12/02 21:59:42 wes Exp $";
#include "gpsee.h"
#include "binary.h"
