 ...
 * @date	Jan 2010
 * @version	$Id: jit.js,v 1.1 2010/02/14 15:44:13 wes Exp $
...
exports.test = function test(whence)
{
  jit_start = Date.now();
  ...
  {
    print("JIT does not appear to be functioning correctly when called " + whence)
  ...
  {
    print("JIT looks good when called " + whence);
    print("With JIT,    the loop ran in " + (jit_end - jit_start) + "ms.");
    print("Without JIT, the loop ran in " + (end - start) + "ms.");
  }
...
exports.test("during module load");
