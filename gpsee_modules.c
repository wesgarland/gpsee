 ...
 *  @version	$Id: gpsee_modules.c,v 1.25 2010/03/06 03:22:18 wes Exp $
 *  @date	March 2009
...
static const char __attribute__((unused)) rcsid[]="$Id: gpsee_modules.c,v 1.25 2010/03/06 03:22:18 wes Exp $:";
